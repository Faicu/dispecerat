...
export const incidentTypes: IncidentTemplate[] = [
  ...
  // Accident types
  { type: 'accident', name: 'Tamponare pe Autostradă', desc: 'Carambol cu 4 vehicule pe A1. Trafic blocat, victime posibile.', req: ['police', 'ambulance', 'fire'], img: 'https://images.unsplash.com/photo-1603202662706-c3df8d98c1a6?auto=format&fit=crop&w=300&q=80', reward: 3500, severity: 2 },
  { type: 'accident', name: 'Accident de Motocicletă', desc: 'Motociclist căzut. Stare gravă raportată de martori.', req: ['ambulance', 'police'], img: 'https://images.unsplash.com/photo-1534069818815-546452296163?auto=format&fit=crop&w=300&q=80', reward: 2000, severity: 2 },
  { type: 'accident', name: 'Prăbușire Schele', desc: 'Schele unui șantier s-au prăbușit, posibile victime prinse sub dărâmături.', req: ['fire', 'fire', 'ambulance', 'ambulance', 'police'], img: 'https://images.unsplash.com/photo-1504307651254-35680f356dfd?auto=format&fit=crop&w=300&q=80', reward: 18000, severity: 3 },
  { type: 'accident', name: 'Om Căzut în Canal', desc: 'Persoană căzută accidental în canal deschis. Risc de înec.', req: ['fire', 'ambulance'], img: 'https://images.unsplash.com/photo-1580974868218-c579c3dcb6b0?auto=format&fit=crop&w=300&q=80', reward: 2800, severity: 2 },
  // Robbery types
  { type: 'robbery', name: 'Tâlhărie Stradală', desc: 'Victimă jefuită în parc. Agresorii au fugit pe jos.', req: ['police'], img: 'https://images.unsplash.com/photo-1572949645841-094f3a9c4c94?auto=format&fit=crop&w=300&q=80', reward: 1200, severity: 1 },
  { type: 'robbery', name: 'Spargere Bijuterie', desc: 'Bijuterie spartă. Alarmă activă. Suspecții ar putea fi încă în interior.', req: ['police', 'swat'], img: 'https://images.unsplash.com/photo-1533031065113-75217aa76878?auto=format&fit=crop&w=300&q=80', reward: 5000, severity: 2 },
  { type: 'robbery', name: 'Furt Vehicul în Mers', desc: 'Carjacking raportat. Victima a reușit să sune de pe stradă.', req: ['police', 'police', 'helicopter'], img: 'https://images.unsplash.com/photo-1549315629-15d2a933d062?auto=format&fit=crop&w=300&q=80', reward: 6500, isMoving: true, severity: 3 },
  // Explosion types
  { type: 'explosion', name: 'Explozie Conductă Gaz', desc: 'Explozie subterană a unei conducte. Risc de incendiu secundar.', req: ['fire', 'fire', 'ambulance', 'police'], img: 'https://images.unsplash.com/photo-1580974868218-c579c3dcb6b0?auto=format&fit=crop&w=300&q=80', reward: 20000, severity: 3 },
  { type: 'explosion', name: 'Explozie Artificii', desc: 'Artificii depozitate necorespunzător s-au aprins. Zona trebuie evacuată.', req: ['fire', 'police', 'ambulance'], img: 'https://images.unsplash.com/photo-1600868285514-6ec177b960b7?auto=format&fit=crop&w=300&q=80', reward: 8000, severity: 2 },
  // Rescue types
  { type: 'rescue', name: 'Persoană Dispărută', desc: 'Bătrân cu demență semnalat dispărut de 3 ore.', req: ['police', 'helicopter'], img: 'https://images.unsplash.com/photo-1596765793043-42e1cc714fb0?auto=format&fit=crop&w=300&q=80', reward: 3000, isMoving: true, severity: 2 },
  { type: 'rescue', name: 'Salvare Montană', desc: 'Drumeț rănit pe un traseu greu accesibil. Necesită elicoper de salvare.', req: ['helicopter', 'ambulance'], img: 'https://images.unsplash.com/photo-1550989460-0adf9ea622e2?auto=format&fit=crop&w=300&q=80', reward: 9000, severity: 2 },
  { type: 'rescue', name: 'Persoană Blocată în Lift', desc: 'Lift oprit între etaje. Pasageri cu probleme medicale.', req: ['fire', 'ambulance'], img: 'https://images.unsplash.com/photo-1504307651254-35680f356dfd?auto=format&fit=crop&w=300&q=80', reward: 1500, severity: 1 },
  { type: 'rescue', name: 'Inundație Subterană', desc: 'Subsol inundat cu persoane blocate. Intervenție urgentă necesară.', req: ['fire', 'fire', 'ambulance', 'police'], img: 'https://images.unsplash.com/photo-1580974868218-c579c3dcb6b0?auto=format&fit=crop&w=300&q=80', reward: 15000, severity: 3 },
];
